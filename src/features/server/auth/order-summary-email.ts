...
function orderSummaryTemplate(order: Order) {
  ...
  const discount = order.coupon
    ? `<tr>
            <td class="table-cell item-name order">Shipping (${order.coupon})</td>
